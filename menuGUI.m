...
% Last Modified by GUIDE v2.5 03-May-2017 19:13:23
...
% --- Executes on button press in monomodoB.
function monomodoB_Callback(hObject, eventdata, handles)
% hObject    handle to monomodoB (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
monomodoGUI


% --- Executes on button press in multimodoSIB.
function multimodoSIB_Callback(hObject, eventdata, handles)
% hObject    handle to multimodoSIB (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in multimodoIGB.
function multimodoIGB_Callback(hObject, eventdata, handles)
% hObject    handle to multimodoIGB (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
multimodoIGGUI
